...
const defaultValues = {
  ...
  banana: {
    ...
    cutCount: 0,
    cutType: "",
    isBananaReadyToHarvest: z.string().nullable(),
  },
...
const Update = ({ fields, refetch, handleModalClose }) => {
  const {
    ...
    // keep disabled (false) to avoid triggering validation by react-hook-form
    ...
    if (fields) {
      ...
      const formData = {
        ...
        turmeric: {
          ...
          totalTurmericQuantity,
          fingerQuantity,
          bulbQuantity,
          isTurmericReadyToHarvest,
        },
        ...
        banana: {
          ...
          tarWeight,
          numberOfBananaTrees,
          numberOfBananaTreesRTH,
          bananaGeneralHarvestCycleInDays,
          cutCount,
          cutType,
          isBananaReadyToHarvest,
        },

        // dry coconut
        dryCoconut: {
          isDryCoconutHarvested,
          isOnTree,
          numberOfDryCoconutsAvailable,
          isWithHusk,
          isWithSemiHusk,
          dryCoconutGeneralHarvestCycleInDays,
          isDryCoconutReadyToHarvest,
        },
      };

      // auto-populate form (reset)
      reset(formData);
      ...
      setDates({
        ...
        lastHarvestDate: dayjs(lastHarvestDate),
      });
    }
  }, [setValue, fields]);
